<?php
/**
 * The template for displaying Damen (Women's) Product Category
 *
 * @package Astra Child
 */
...
// Damen hero images (desktop + mobile)
$hero_desktop = 'https://davaksparfums.ch/wp-content/uploads/2026/01/davaks-damen-hero-desktop.png';
$hero_mobile  = 'https://davaksparfums.ch/wp-content/uploads/2026/01/davaks-damen-hero-mobile.png';
	...
	<main id="main" class="site-main">
        ...
        <section class="davaks-category-hero" style="position: relative; height: 90vh; display: flex; align-items: center; justify-content: center; overflow: hidden; width: 100vw;">
			...
			<div class="davaks-hero-content" style="position: relative; z-index: 2; text-align: center; max-width: 900px; padding: 20px;">
				<h1 style="color: #fff; font-size: clamp(2.5rem, 5vw, 4rem); margin-bottom: 1.5rem; font-weight: 400; letter-spacing: 2px; text-transform: uppercase;">Damenparfums</h1>
				<p style="color: #f5f5f5; font-size: clamp(1.1rem, 2vw, 1.4rem); font-weight: 300; letter-spacing: 0.5px; opacity: 0.9;">Düfte mit Ausdruck, Balance und Charakter.</p>
			</div>
		</section>
		...
		<div class="davaks-container" style="max-width: 1300px; margin: 0 auto; padding: 0 20px;">
			...
			<section class="davaks-criterio" style="padding: 100px 0; text-align: center; max-width: 760px; margin: 0 auto;">
				<h2 style="font-size: 1.1rem; text-transform: uppercase; letter-spacing: 3px; color: #888; margin-bottom: 24px;">Auswahl mit Feingefühl</h2>
				<p style="font-size: 1.5rem; line-height: 1.6; color: #e5e5e5; font-weight: 300;">
					Diese Kollektion richtet sich an Frauen mit einem klaren Gespür für Stil.
					Jeder Duft wurde bewusst ausgewählt – nach Ausdruck, Harmonie und Beständigkeit.
					Nicht gefällig. Sondern stimmig.
				</p>
			</section>
                    ...
                    $args1 = array(
                        ...
                        'tax_query' => array(
                            array(
                                ...
                                'field'    => 'slug',
                                'terms'    => 'damen-2', // Match slug
                            ),
                        ),
                    );
                    if( ! term_exists('damen-2', 'product_cat') ) {
                         $args1['tax_query'][0]['terms'] = 'damen';
                    }
            ...
            <section class="davaks-editorial" style="background: #141414; padding: 0; margin-bottom: 100px; display: grid; grid-template-columns: 1fr 1fr; gap: 0px; align-items: stretch; min-height: 450px;">
                <div class="editorial-text" style="padding: 80px 60px; display: flex; flex-direction: column; justify-content: center;">
                    ...
                    <h3 style="color: #fff; margin-bottom: 24px; font-size: 2.2rem; font-weight: 400; line-height: 1.2;">Ein Duft ergänzt nicht.<br>Er unterstreicht Persönlichkeit.</h3>
                    <p style="color: #bbb; font-size: 1.1rem; line-height: 1.6; max-width: 450px;">Ein außergewöhnliches Parfum ist wie unsichtbarer Schmuck. Es kleidet Sie, ohne zu verkleiden. Unsere Damenkollektion setzt auf feine Nuancen statt auf laute Effekte.</p>
                </div>
                <div class="editorial-image" style="background-image: url('https://davaksparfums.ch/wp-content/uploads/2026/01/davaks-damen-editorial-desktop.png'); background-size: cover; background-position: center; min-height: 300px; background-color: #222;">
					<!-- Image placeholder - logic to pick generic lifestyle or specific damen image -->
                    <img src="https://davaksparfums.ch/wp-content/uploads/2026/01/davaks-damen-editorial-desktop.png" srcset="https://davaksparfums.ch/wp-content/uploads/2026/01/davaks-damen-editorial-mobile.png 900w, https://davaksparfums.ch/wp-content/uploads/2026/01/davaks-damen-editorial-desktop.png 1600w" sizes="(max-width: 768px) 100vw, 50vw" style="width:100%; height:100%; object-fit:cover; display:block; opacity:0;" alt="Editorial Damen">
				</div>
			</section>
            ...
            <style>
                @media(max-width: 768px) {
                    ...
                    .editorial-image { background-image: url('https://davaksparfums.ch/wp-content/uploads/2026/01/davaks-damen-editorial-mobile.png') !important; }
			...
			<section class="davaks-product-grid-2" style="margin-bottom: 120px;">
                <?php 
                    ...
                    if( ! term_exists('damen-2', 'product_cat') ) {
                         $args2['tax_query'][0]['terms'] = 'damen';
                    }

                    $loop2 = new WP_Query( $args2 );
                    
                    if ( $loop2->have_posts() ) :
                        echo '<h4 style="color: #666; text-transform: uppercase; letter-spacing: 2px; font-size: 0.9rem; margin-bottom: 40px; text-align: center;">Weitere Nuancen entdecken</h4>';
                        echo '<ul class="products columns-4" style="display: grid; grid-template-columns: repeat(auto-fill, minmax(280px, 1fr)); gap: 40px;">';
            ...
            <section class="davaks-closing" style="text-align: center; padding-bottom: 100px; color: #555; font-style: italic;">
                <p>Parfums für Frauen, die ihren eigenen Weg gehen.</p>
            </section>
