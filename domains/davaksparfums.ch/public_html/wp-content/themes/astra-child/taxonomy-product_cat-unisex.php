<?php
/**
 * The template for displaying Unisex Product Category
 *
 * @package Astra Child
 */
	...
	<main id="main" class="site-main">
		...
		<section class="davaks-category-hero" style="position: relative; height: 75vh; min-height: 500px; display: flex; align-items: center; justify-content: center; overflow: hidden;">
			...
			<div class="davaks-hero-content" style="position: relative; z-index: 2; text-align: center; max-width: 900px; padding: 20px;">
				<h1 style="color: #fff; font-size: clamp(2.5rem, 5vw, 4rem); margin-bottom: 1.5rem; font-weight: 400; letter-spacing: 2px; text-transform: uppercase;">Unisexparfums</h1>
				<p style="color: #f5f5f5; font-size: clamp(1.1rem, 2vw, 1.4rem); font-weight: 300; letter-spacing: 0.5px; opacity: 0.9;">Düfte jenseits von Zuordnung – klar, ausgewogen und zeitlos.</p>
			</div>
		</section>
		...
		<div class="davaks-container" style="max-width: 1300px; margin: 0 auto; padding: 0 20px;">
			...
			<section class="davaks-criterio" style="padding: 100px 0; text-align: center; max-width: 760px; margin: 0 auto;">
				<h2 style="font-size: 1.1rem; text-transform: uppercase; letter-spacing: 3px; color: #888; margin-bottom: 24px;">Auswahl mit Balance</h2>
				<p style="font-size: 1.5rem; line-height: 1.6; color: #e5e5e5; font-weight: 300;">
					Diese Kollektion richtet sich an Menschen, die Duft nicht zuordnen, sondern empfinden.
					Jeder Duft wurde bewusst ausgewählt – nach Klarheit, Struktur und Ausgewogenheit.
					Nicht erklärend. Sondern selbstverständlich.
				</p>
			</section>
                    ...
                    $args1 = array(
                        ...
                        'tax_query' => array(
                            array(
                                ...
                                'field'    => 'slug',
                                'terms'    => 'unisex-2', // Variant
                            ),
                        ),
                    );
                    if( ! term_exists('unisex-2', 'product_cat') ) {
                         $args1['tax_query'][0]['terms'] = 'unisex';
                    }
            ...
            <section class="davaks-editorial" style="background: #141414; padding: 0; margin-bottom: 100px; display: grid; grid-template-columns: 1fr 1fr; gap: 0px; align-items: stretch; min-height: 450px;">
                <div class="editorial-text" style="padding: 80px 60px; display: flex; flex-direction: column; justify-content: center;">
                    ...
                    <p style="color: #bbb; font-size: 1.1rem; line-height: 1.6; max-width: 450px;">In der Nischenparfümerie verschwimmen die Grenzen. Es geht um Kontraste: hell und dunkel, weich und rau. Entdecken Sie Düfte, die sich nicht in Schubladen stecken lassen.</p>
                </div>
			...
			<section class="davaks-product-grid-2" style="margin-bottom: 120px;">
                <?php 
                    ...
                    if( ! term_exists('unisex-2', 'product_cat') ) {
                         $args2['tax_query'][0]['terms'] = 'unisex';
                    }

                    $loop2 = new WP_Query( $args2 );

                    if ( $loop2->have_posts() ) :
                        echo '<h4 style="color: #666; text-transform: uppercase; letter-spacing: 2px; font-size: 0.9rem; margin-bottom: 40px; text-align: center;">Mehr entdecken</h4>';
                        echo '<ul class="products columns-4" style="display: grid; grid-template-columns: repeat(auto-fill, minmax(280px, 1fr)); gap: 40px;">';
			...
			<section class="davaks-cat-faq" style="max-width: 800px; margin: 0 auto 100px auto;">
				<h3 style="text-align: center; color: #fff; margin-bottom: 50px; font-weight: 400;">Häufige Fragen zu Unisex-Düften</h3>
				<div class="faq-grid" style="display: grid; gap: 16px;">
					<details style="background: #141414; padding: 24px; border-radius: 6px; cursor: pointer;">
						<summary style="color: #e5e5e5; font-weight: 500; font-size: 1.05rem; list-style: none; display: flex; justify-content: space-between; align-items: center;">
                             Sind diese Düfte wirklich für alle?
                            <span style="color: #666;">+</span>
                        </summary>
                        <p style="margin-top: 16px; color: #aaa; line-height: 1.6;">Unisex bedeutet bei Davaks: Düfte, die nicht zugeordnet werden, sondern durch Balance und Klarheit überzeugen.</p>
					</details>
					<details style="background: #141414; padding: 24px; border-radius: 6px; cursor: pointer;">
						<summary style="color: #e5e5e5; font-weight: 500; font-size: 1.05rem; list-style: none; display: flex; justify-content: space-between; align-items: center;">
                            Für wen sind Unisexparfums geeignet?
                            <span style="color: #666;">+</span>
                        </summary>
						<p style="margin-top: 16px; color: #aaa; line-height: 1.6;">Für Menschen mit einem eigenständigen Stilverständnis – unabhängig von Konventionen.</p>
					</details>
					<details style="background: #141414; padding: 24px; border-radius: 6px; cursor: pointer;">
						<summary style="color: #e5e5e5; font-weight: 500; font-size: 1.05rem; list-style: none; display: flex; justify-content: space-between; align-items: center;">
                        ...
                        <p style="margin-top: 16px; color: #aaa; line-height: 1.6;">Die Auswahl legt den Fokus auf Ausgewogenheit und Vielseitigkeit.</p>
                    </details>
                </div>
            </section>
			...
			<section class="davaks-closing" style="text-align: center; padding-bottom: 100px; color: #555; font-style: italic;">
				<p>Unisexparfums für Menschen mit Klarheit, Ruhe und Haltung.</p>
			</section>
