<?php
/**
 * Register Password Field controller.
 *
 * @since 2.0.0
 * @package Spectra Pro
 */
...
$field_type        = $attributes['fieldType'] ?? 'password'; // Field type for register-password block.
...
// Context label and placeholder values.
...
switch ( $field_type ) {
	case 'password':
		$effective_label       = $field_label ? $field_label : ( $context_password_label ? $context_password_label : __( 'Password', 'spectra-pro' ) );
		$effective_placeholder = $field_placeholder ? $field_placeholder : ( $context_password_placeholder ? $context_password_placeholder : __( 'Enter your password', 'spectra-pro' ) );
...
$additional_classes = array(
	'spectra-pro-register-password',
	'spectra-pro-form-input-wrapper--' . esc_attr( $field_type ),
);

// Get the block wrapper attributes, and extend the styles and classes.
$wrapper_attributes = BlockAttributes::get_wrapper_attributes( $attributes, $config, array( 'id' => 'register-password-' . esc_attr( $block_id ) ), $additional_classes );
