...
* New: Redesigned architecture powered by WordPress Interactivity API and modern block controls for enhanced performance, compatibility and user experience.
* New: Loop Builder – Completely reworked the powerful block system for displaying posts with advanced filtering, search, sorting, and AJAX-powered pagination.
* New: Login Block – Redesigned the comprehensive user authentication block with customizable form fields, remember me functionality, and desing customization settings.
* New: Register Block – Rebuilt the user registration block with validation, custom fields, and abundant styling options.
* New: Global Styles Extension – Comprehensive design system with CSS variables, custom classes, and block defaults.
* New: Dynamic Content Extension – Display dynamic content from posts, custom fields, ACF, and user data across supported blocks.
* New: Animations Extension – Enhanced animation support with scroll-triggered effects.
* New: Modal Pro – Enhanced modal functionality with off-canvas sidebars, more UI options, and more trigger types.
* New: Countdown Pro – Display custom content after countdown timer expires with flexible styling options.
* New: Popup Builder Pro – Advanced popup creation with display conditions and various trigger types.
* New: Slider Pro – Improved slider capabilities including hash navigation, custom class-based navigation, and control over slides per view.

= 1.2.5 - Wednesday, 16th July 2025 =
* Fix: Dynamic Content - Resolved an issue where fallback images were not being properly applied in the editor for the post custom field.
* Fix: Dynamic Content - Prevented errors during dynamic content rendering when non-string values are used. 

= 1.2.4 - Wednesday, 18th June 2025 =
* Cleaned up analytics logic in Pro for better core control.

= 1.2.3 - Wednesday, 4th June 2025 =
* Fix: Dynamic Content - Resolved an issue where ACF checkbox field types were not being properly displayed in the editor and on the frontend.

= 1.2.2 - Tuesday, 20th May 2025 =
* New: Added translations for the Spanish, French, and Dutch languages.
* Improvement: Removed unused assets from the Login/Register blocks.
* Fix: Loop Builder - Resolved an issue where the category filter would not work for the pagination.
* Fix: Container - Resolved an issue where dynamic content fallback images were not being properly applied in the editor for the author custom field.
* Fix: Dynamic Content - Resolved an issue in which the Read More button on the latest posts block would not appear when Spectra Pro is enabled.

= 1.2.1 - Thursday, 17th April 2025 =
* Improvement: Improved code quality.
* Fix: Dynamic Content - Resolved an issue wherein dynamic content post excerpt character length was not being applied with large values.

= 1.2.0 - Monday, 20th January 2025 =
* New: Loop Builder - Now supports Search, Sort, Category, and Reset Filters for improved content filtering and management.
* Improvement: Loop Builder - Pagination is now powered by AJAX, offering a smoother and faster user experience.

= 1.1.10 - Wednesday, 8th January 2025 =
